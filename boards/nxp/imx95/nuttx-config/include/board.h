/****************************************************************************
 * boards/arm/imx95/imx95-evk/include/board.h
 *
...
#ifndef __BOARDS_NXP_IMX95_NUTTX_CONFIG_INCLUDE_BOARD_H
#define __BOARDS_NXP_IMX95_NUTTX_CONFIG_INCLUDE_BOARD_H
...
#define LPI2C8_CLK                 (LPI2C8_CLK_ROOT_OSC_24M_CLK | CLOCK_DIV(1))
#define LPSPI1_CLK                 (LPSPI1_CLK_ROOT_OSC_24M_CLK | CLOCK_DIV(1))
#define LPSPI4_CLK                 (LPSPI4_CLK_ROOT_OSC_24M_CLK | CLOCK_DIV(1))
...
#define FLEXCAN5_CLK               (CAN5_CLK_ROOT_SYS_PLL1_DFS1_DIV2_CLK | CLOCK_DIV(5))
...
#define MUX_LPI2C8_SCL       IOMUX_CFG(IOMUXC_PAD_GPIO_IO11_LPI2C8_SCL, IOMUX_LPI2C_DEFAULT, IOMUXC_MUX_SION_ON)
#define MUX_LPI2C8_SDA       IOMUX_CFG(IOMUXC_PAD_GPIO_IO10_LPI2C8_SDA, IOMUX_LPI2C_DEFAULT, IOMUXC_MUX_SION_ON)


/* I3C */

#define MUX_I3C_SCL       IOMUX_CFG(IOMUXC_PAD_ENET1_MDC_I3C2_SCL, IOMUX_LPI2C_DEFAULT, IOMUXC_MUX_SION_ON)
#define MUX_I3C_SDA       IOMUX_CFG(IOMUXC_PAD_ENET1_MDIO_I3C2_SDA, IOMUX_LPI2C_DEFAULT, IOMUXC_MUX_SION_ON)
...
#define MUX_LPSPI4_SCK       IOMUX_CFG(IOMUXC_PAD_GPIO_IO37_LPSPI4_SCK,  IOMUX_LPSPI_DEFAULT, IOMUXC_MUX_SION_ON)
#define MUX_LPSPI4_MOSI      IOMUX_CFG(IOMUXC_PAD_GPIO_IO36_LPSPI4_SOUT, IOMUX_LPSPI_DEFAULT, IOMUXC_MUX_SION_ON)
#define MUX_LPSPI4_MISO      IOMUX_CFG(IOMUXC_PAD_GPIO_IO19_LPSPI4_SIN,  IOMUX_LPSPI_DEFAULT, IOMUXC_MUX_SION_ON)
...
#define MUX_LPSPI4_CS        IOMUX_CFG(IOMUXC_PAD_GPIO_IO17_GPIO2_IO17,  IOMUX_LPSPI_DEFAULT, IOMUXC_MUX_SION_ON)
#define MUX_LPSPI4_CS1       IOMUX_CFG(IOMUXC_PAD_GPIO_IO16_GPIO2_IO16,  IOMUX_LPSPI_DEFAULT, IOMUXC_MUX_SION_ON)
...
#define GPIO_LPSPI4_CS       (GPIO_PORT2 | GPIO_PIN17 | GPIO_OUTPUT | GPIO_OUTPUT_ONE)
#define GPIO_LPSPI4_CS1      (GPIO_PORT2 | GPIO_PIN16 | GPIO_OUTPUT | GPIO_OUTPUT_ONE)
...
#define GPIO_FLEXCAN5_TX     IOMUX_CFG(IOMUXC_PAD_GPIO_IO22_CAN5_TX,  IOMUX_GPIO_DEFAULT, IOMUXC_MUX_SION_ON)
#define GPIO_FLEXCAN5_RX     IOMUX_CFG(IOMUXC_PAD_GPIO_IO23_CAN5_RX,  IOMUX_GPIO_DEFAULT, IOMUXC_MUX_SION_ON)
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_NXP_IMX95_NUTTX_CONFIG_INCLUDE_BOARD_H */
